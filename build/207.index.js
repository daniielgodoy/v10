...
const { isLinux, getReport } = __webpack_require__(36395);
const { LDD_PATH, SELF_PATH, readFile, readFileSync } = __webpack_require__(14591);
const { interpreterPath } = __webpack_require__(39103);
...
const parseOptions = __webpack_require__(32860)
const { safeRe: re, t } = __webpack_require__(40439)
const cmp = __webpack_require__(88158)
const debug = __webpack_require__(25727)
const SemVer = __webpack_require__(87539)
const Range = __webpack_require__(96182)
...
const LRU = __webpack_require__(19599)
const cache = new LRU()

const parseOptions = __webpack_require__(32860)
const Comparator = __webpack_require__(57051)
const debug = __webpack_require__(25727)
const SemVer = __webpack_require__(87539)
const {
  safeRe: re,
  ...
  tildeTrimReplace,
  caretTrimReplace,
} = __webpack_require__(40439)
const { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = __webpack_require__(86677)
...
const debug = __webpack_require__(25727)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __webpack_require__(86677)
const { safeRe: re, t } = __webpack_require__(40439)

const parseOptions = __webpack_require__(32860)
const { compareIdentifiers } = __webpack_require__(50396)
class SemVer {
...
const eq = __webpack_require__(55970)
const neq = __webpack_require__(56230)
const gt = __webpack_require__(37711)
const gte = __webpack_require__(27644)
const lt = __webpack_require__(42856)
const lte = __webpack_require__(26405)
...
const SemVer = __webpack_require__(87539)
const parse = __webpack_require__(59049)
const { safeRe: re, t } = __webpack_require__(40439)
...
const compare = __webpack_require__(33581)
...
const is = __webpack_require__(64923);
...
const color = __webpack_require__(62275);
const is = __webpack_require__(64923);
...
const Sharp = __webpack_require__(31727);
__webpack_require__(40559)(Sharp);
__webpack_require__(82107)(Sharp);
__webpack_require__(23564)(Sharp);
__webpack_require__(94230)(Sharp);
__webpack_require__(36335)(Sharp);
__webpack_require__(97092)(Sharp);
__webpack_require__(43730)(Sharp);
__webpack_require__(56795)(Sharp);
...
const is = __webpack_require__(64923);
const sharp = __webpack_require__(44687);
...
const semverCoerce = __webpack_require__(28193);
const semverGreaterThanOrEqualTo = __webpack_require__(27644);
const semverSatisfies = __webpack_require__(70739);
const detectLibc = __webpack_require__(38476);

const { config, engines, optionalDependencies } = __webpack_require__(87816);
...
const buildSharpLibvipsIncludeDir = () => {
  try {
    return __WEBPACK_EXTERNAL_createRequire(import.meta.url)(`@img/sharp-libvips-dev-${buildPlatformArch()}/include`);
  } catch {
    try {
...
const buildSharpLibvipsCPlusPlusDir = () => {
  try {
    return __webpack_require__(67467);
  } catch {}
  /* istanbul ignore next */
  return '';
};
...
const buildSharpLibvipsLibDir = () => {
  try {
    return __WEBPACK_EXTERNAL_createRequire(import.meta.url)(`@img/sharp-libvips-dev-${buildPlatformArch()}/lib`);
  } catch {
    try {
      return __WEBPACK_EXTERNAL_createRequire(import.meta.url)(`@img/sharp-libvips-${buildPlatformArch()}/lib`);
    } catch {}
  }
  /* istanbul ignore next */
  return '';
...
const { familySync, versionSync } = __webpack_require__(38476);

const { runtimePlatformArch, isUnsupportedNodeRuntime, prebuiltPlatforms, minimumLibvipsVersion } = __webpack_require__(13692);
...
for (path of paths) {
  try {
    sharp = __WEBPACK_EXTERNAL_createRequire(import.meta.url)(path);
    break;
  } catch (err) {
    /* istanbul ignore next */
    errors.push(err);
...
if (sharp) {
  ...
  if (isLinux && /(symbol not found|CXXABI_)/i.test(messages)) {
    try {
      const { config } = __WEBPACK_EXTERNAL_createRequire(import.meta.url)(`@img/sharp-libvips-${runtimePlatform}/package`);
...
const is = __webpack_require__(64923);
const { runtimePlatformArch } = __webpack_require__(13692);
const sharp = __webpack_require__(44687);
...
if (!libvipsVersion.isGlobal) {
  if (!libvipsVersion.isWasm) {
    try {
      versions = __WEBPACK_EXTERNAL_createRequire(import.meta.url)(`@img/sharp-${runtimePlatform}/versions`);
    } catch (_) {
      try {
        versions = __WEBPACK_EXTERNAL_createRequire(import.meta.url)(`@img/sharp-libvips-${runtimePlatform}/versions`);
      } catch (_) {}
    }
  } else {
    try {
      versions = __webpack_require__(10171);
    } catch (_) {}
  }
}
versions.sharp = (__webpack_require__(87816).version);
...
module.exports = __webpack_require__(83742)["default"];
